package pe.edu.upc.taskmaster.backend.unit.tests;
...
public class UserTests {
    ...
    void updateUserDetails_ShouldUpdateUsernameAndPassword() {
        UpdateUserCommand command = new UpdateUserCommand("Omar", "Luquillas", "imagen.png", 10000.00, "923157544", 22, "Estudiante de Ingeniería de Software");

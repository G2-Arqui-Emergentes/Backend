package pe.edu.upc.taskmaster.backend.project.domain.model.aggregates;

import jakarta.persistence.*;
import lombok.Getter;
import pe.edu.upc.taskmaster.backend.iam.domain.model.aggregates.User;
import pe.edu.upc.taskmaster.backend.project.domain.model.commands.CreateProjectCommand;
import pe.edu.upc.taskmaster.backend.project.domain.model.commands.UpdateProjectCommand;
...
public class Project extends AuditableAbstractAggregateRoot<Project> {
    ...
    @ManyToMany(mappedBy = "memberInProjects", fetch = FetchType.LAZY)
    ...
    public void addMember(User user) {
        ...
        user.getMemberInProjects().add(this);
    }

    public void removeMember(User user) {
        this.members.remove(user);
        user.getMemberInProjects().remove(this);
    }
}

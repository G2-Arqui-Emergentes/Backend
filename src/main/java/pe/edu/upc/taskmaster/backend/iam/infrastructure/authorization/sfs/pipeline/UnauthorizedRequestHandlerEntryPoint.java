package pe.edu.upc.taskmaster.backend.iam.infrastructure.authorization.sfs.pipeline;
    ...
    */
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authenticationException) throws IOException, ServletException {
        ...
        if (requestURI.equals("/sw.js") ||
            ...
            LOGGER.debug("Unauthorized request to permitted resource: {}", requestURI);
            response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Unauthorized request detected");
            return;
        }

        LOGGER.error("Unauthorized request: {} - {}", requestURI, authenticationException.getMessage());
        response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Unauthorized request detected");
    }
}

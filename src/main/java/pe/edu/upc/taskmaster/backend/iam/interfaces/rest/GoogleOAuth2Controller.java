...
public class GoogleOAuth2Controller {
    ...
    public void connect(HttpServletRequest request,
                        ...
                        @org.springframework.security.core.annotation.AuthenticationPrincipal UserDetailsImpl userDetails) throws IOException {
        var session = request.getSession(true);
        session.setAttribute("google_connection_user_id", userDetails.getId());
